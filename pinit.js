	...
	var a = n[m.k] = {
		...
		f : function() {
			return {
				...
				get : function(b, d) {
					var c = null;
					return c = typeof b[d] === "string" ? b[d] : b
							.getAttribute(d)
				},
				getData : function(b, d) {
					d = a.a.dataAttributePrefix + d;
					return a.f.get(b, d)
				},
				set : function(b, d, c) {
				...
				make : function(b) {
					...
					for (c in b)
						if (b[c].hasOwnProperty) {
							d = a.d.createElement(c);
							for (e in b[c])
								b[c][e].hasOwnProperty
										&& typeof b[c][e] === "string"
										&& a.f.set(d, e, b[c][e]);
							break
						}
				...
				getEl : function(b) {
					var d = null;
					return d = b.target ? b.target.nodeType === 3 ? b.target.parentNode
							: b.target
							: b.srcElement
				},
				listen : function(b, d, c) {
					if (typeof a.w.addEventListener !== "undefined")
						b.addEventListener(d, c, false);
					else
						typeof a.w.attachEvent !== "undefined"
								&& b.attachEvent("on" + d, c)
				},
				call : function(b, d) {
					var c, e, f = "?";
					c = a.f.callback.length;
					e = a.a.k + ".f.callback[" + c + "]";
					a.f.callback[c] = function(g) {
						d(g, c);
						a.f.kill(e)
					};
					if (b.match(/\?/))
				...
				debug : function(b) {
					a.v.config.debug && a.w.console && a.w.console.log
							&& a.w.console.log(b)
				},
				presentation : function() {
					...
					d = a.a.cdn[a.w.location.protocol] || a.a.cdn["http:"];
					c = a.a.rules.join("\n");
					c = c.replace(/\._/g, "." + m.k + "_");
					c = c.replace(/;/g, "!important;");
					c = c.replace(/_cdn/g, d);
					c = c.replace(/_rez/g, a.v.resolution);
					if (b.styleSheet)
						b.styleSheet.cssText = c;
					else
						b.appendChild(a.d.createTextNode(c));
				...
				hideFloatingButton : function() {
					a.s.floatingButton.style.display = "none"
				},
				getThis : function(b, d) {
					b = a.a.endpoint.builder + b + "&" + d;
					a.f.log("&type=getThis&href=" + encodeURIComponent(b));
					a.w.open(b, "pin" + (new Date).getTime())
				},
				showFloatingButton : function(b) {
					if (b.height > a.a.minImgSize && b.width > a.a.minImgSize
							&& !b.src.match(/^data/)) {
						if (!a.s.floatingButton) {
							a.s.floatingButton = a.f
									.make( {
										A : {
											className :a.a.k
													+ "_pin_it_button " + a.a.k
													+ "_pin_it_button_floating",
											title :"Pin it!",
											target :"_blank"
										}
									});
							a.f.set(a.s.floatingButton, a.a.dataAttributePrefix
									+ "log", "button_pinit_floating");
							a.d.b.appendChild(a.s.floatingButton)
						}
						var d = a.f.getPos(b), c = a.a.endpoint.create;
						c = c
								+ "url="
								+ encodeURIComponent(a.d.URL)
								+ "&media="
								+ encodeURIComponent(b.src)
								+ "&description="
								+ encodeURIComponent(b
										.getAttribute("data-pin-description")
										|| b.title || b.alt || a.d.title);
						a.s.floatingButton.href = c;
						a.s.floatingButton.onclick = function() {
							a.w.open(this.href, "pin" + (new Date).getTime(),
									a.a.pop);
							a.f.hideFloatingButton();
							return a.v.hazFloatingButton = false
						};
						a.s.floatingButton.style.top = d.top
								+ a.a.floatingButtonOffsetTop + "px";
						a.s.floatingButton.style.left = d.left
								+ a.a.floatingButtonOffsetLeft + "px";
						a.s.floatingButton.style.display = "block"
					}
				},
				over : function(b) {
					if (b = a.f.getEl(b || a.w.event))
						if (b.tagName === "IMG" && b.src
								&& !a.f.getData(b, "no-hover")
								&& !a.f.get(b, "nopin") && a.v.config.hover) {
							if (a.v.hazFloatingButton === false)
								a.v.hazFloatingButton = true;
							else
								a.f.hideFloatingButton();
							a.f.showFloatingButton(b)
						} else if (a.v.hazFloatingButton === true)
							if (b !== a.s.floatingButton) {
								a.v.hazFloatingButton = false;
								a.f.hideFloatingButton()
							}
				},
				click : function(b) {
					...
					if ((b = a.f.getEl(b || a.w.event)) && b !== a.d.b) {
						if (!a.f.getData(b, "log"))
							b = b.parentNode;
						if (d = a.f.getData(b, "log"))
							if (a.f.get(b, "href").match(/pinterest/)) {
								if (!b.className.match(/hazClick/))
									b.className = b.className + " " + a.a.k
											+ "_hazClick";
								a.f.log("&type=" + d + "&href="
										+ encodeURIComponent(b.href))
							}
					}
				},
				behavior : function() {
					...
					a.v.config.hover
							&& a.f.listen(a.d.b, "mouseover", a.f.over)
				},
				getPinCount : function(b) {
					b = "?url=" + b + "&ref=" + encodeURIComponent(a.v.here)
							+ "&source=" + a.a.countSource;
					a.f.call(a.a.endpoint.count + b, a.f.ping.count)
				},
				prettyPinCount : function(b) {
					if (b > 999)
						b = b < 1E6 ? parseInt(b / 1E3, 10) + "K+"
								: b < 1E9 ? parseInt(b / 1E6, 10) + "M+" : "++";
					return b
				},
				tile : function(b, d) {
					...
					if (e && e >= a.a.tile.scale.minHeight)
						c.height = parseInt(e, 10);
					if ((e = a.f.getData(b, "scale-width"))
							&& e >= a.a.tile.scale.minWidth)
						c.width = parseInt(e, 10);
					e = a.f.getData(b, "board-width") || b.offsetWidth;
					if (e > b.offsetWidth)
						e = b.offsetWidth;
					e = Math.floor(e / (c.width + a.a.tile.style.margin));
					if (e > a.a.tile.maxColumns)
						e = a.a.tile.maxColumns;
					if (e < a.a.tile.minColumns)
						return false;
					var f = a.f.make( {
						SPAN : {
					...
					a.v.renderedWidth = e * (c.width + a.a.tile.style.margin)
							- a.a.tile.style.margin;
					f.style.width = a.v.renderedWidth + "px";
					for ( var g = 0, h = [], k = 0, p = d.length; k < p; k += 1) {
						var j = a.f.make( {
							A : {
								className :a.a.k + "_embed_board_th",
								target :"_blank",
								href :b.href,
								title :d[k].description
							}
						});
						a.f.set(j, a.a.dataAttributePrefix + "log",
								"embed_board");
						var i = {
							height :d[k].images["237x"].height
									* (c.width / d[k].images["237x"].width),
							width :c.width
						}, l = a.f.make( {
							IMG : {
								src :d[k].images["237x"].url,
								nopin :"true",
								height :i.height,
								width :i.width,
						...
						l.style.marginTop = 0 - i.height
								/ a.a.tile.style.margin + "px";
						if (i.height > c.height)
							i.height = c.height;
						j.appendChild(l);
						j.style.height = i.height + "px";
						j.style.width = i.width + "px";
						h[g] || (h[g] = 0);
						j.style.top = h[g] + "px";
						j.style.left = g * (c.width + a.a.tile.style.margin)
								+ "px";
						h[g] = h[g] + i.height + a.a.tile.style.margin;
						j.appendChild(l);
						f.appendChild(j);
						g = (g + 1) % e
					}
				...
				makeFooter : function(b, d) {
					...
					if (a.v.renderedWidth > a.a.tile.minWidthToShowAuxText)
						b.innerHTML = "See On";
					a.f.set(b, a.a.dataAttributePrefix + "log", d);
					d = a.f.make( {
						SPAN : {
				...
				cssHook : function(b, d) {
					if (b = a.f.getData(b, "css-hook"))
				...
				fireBookmark : function() {
					a.v.firstScript.parentNode.insertBefore(a.f.make( {
						SCRIPT : {
							type :"text/javascript",
							charset :"utf-8",
							src :a.a.endpoint.bookmark + "?r=" + Math.random()
									* 99999999
						}
					}), a.v.firstScript)
				},
				ping : {
					...
					count : function(b, d) {
						if (d = a.d.getElementById(a.a.k + "_pin_count_" + d)) {
							a.f.debug("API replied with count: " + b.count);
							var c = d.parentNode, e = a.f.getData(c, "config");
							if (b.count === 0)
								if (e === "above") {
									a.f.debug("Rendering zero count above.");
									d.className = a.a.k
											+ "_pin_it_button_count";
									d.appendChild(a.d.createTextNode("0"))
								} else
									a.f
											.debug("Zero pin count not rendered to the side.");
							if (b.count > 0) {
								a.f.debug("Got " + b.count
										+ " pins for the requested URL.");
								if (e === "above" || e === "beside") {
									a.f.debug("Rendering pin count " + e);
									d.className = a.a.k
											+ "_pin_it_button_count";
									d.appendChild(a.d.createTextNode(a.f
											.prettyPinCount(b.count)))
								} else
									a.f
											.debug("No valid pin count position specified; not rendering.")
							}
							a.f.cssHook(c, d)
						} else
					...
					pin : function(b, d) {
						if ((d = a.d.getElementById(a.a.k + "_" + d)) && b.data
								&& b.data[0]) {
							...
							if (b.images)
								c = b.images["237x"];
							if (b && b.id && b.description && c.url && c.width
									&& c.height) {
								...
								if (a.f.getData(d, "style") !== "plain")
									e.className = e.className + " " + a.a.k
											+ "_fancy";
								var f = a.f.make( {
									A : {
										className :a.a.k + "_embed_pin_link",
										href :"http://pinterest.com/pin/"
												+ b.id + "/",
										target :"_blank"
									}
								}), g = a.f.make( {
								...
								c.onclick = function() {
									if (!this.className.match(/hazClick/))
										this.className = this.className + " "
												+ a.a.k + "_hazClick";
									var h = a.a.endpoint.repin.replace(/%s/,
											a.f.get(this, "data-pin-id"));
									a.f.log("&type=repin&href="
											+ encodeURIComponent(h));
									a.w.open(h, "pin" + (new Date).getTime(),
											a.a.popLarge);
									return false
								};
								c = a.f.make( {
									I : {
										className :a.a.k + "_getThis",
										innerHTML :"get this<i></i>",
										"data-pin-id" :b.id
									}
								});
								f.appendChild(c);
								c.onclick = function() {
									var h = a.f.get(this, "data-pin-id");
									a.f.getThis("do_embed_pin", h);
									return false
								};
								a.f.set(f, a.a.dataAttributePrefix + "log",
										"embed_pin");
								e.appendChild(f);
								f = a.f.make( {
									SPAN : {
								...
								if (b.attribution && b.attribution.url
										&& b.attribution.author_name
										&& b.attribution.provider_icon_url) {
											...
											.appendChild(a.f
													.make( {
														IMG : {
															...
															src :b.attribution.provider_icon_url
														}
													}));
								...
								e.appendChild(f);
								if (b.pinner && b.pinner.profile_url
										&& b.pinner.image_small_url
										&& b.pinner.full_name) {
									a.f.debug("Building pinner line");
									f = a.f.make( {
										A : {
											className :a.a.k
													+ "_embed_pin_text",
											href :b.pinner.profile_url,
											target :"_blank"
										}
									});
									a.f.set(f, a.a.dataAttributePrefix + "log",
											"pinner_from_embedded_pin");
									f.appendChild(a.f.make( {
										IMG : {
											className :a.a.k
													+ "_embed_pin_text_avatar",
											src :b.pinner.image_small_url
										}
									}));
									f
											.appendChild(a.f
													.make( {
														SPAN : {
															className :a.a.k
																	+ "_embed_pin_text_container",
															innerHTML :'Pinned by <em class="'
																	+ a.a.k
																	+ '_embed_pin_text_container_em">'
																	+ b.pinner.full_name
																	+ "</em>"
														}
													}));
									f.appendChild(a.f.make( {
										B : {
											className :a.a.k
													+ "_embed_pin_link_shield"
										}
									}));
									e.appendChild(f)
								}
								if (b.board && b.board.url
										&& b.board.image_thumbnail_url
										&& b.board.name) {
									a.f.debug("Building board line");
									if (!b.board.url
											.match(/^(\/\/pinterest\.com|http:\/\/pinterest\.com|https:\/\/pinterest\.com)/)) {
										b.board.url = "//pinterest.com"
												+ b.board.url;
										a.f
												.debug("appending Pinterest prefix to board URL")
									}
									f = a.f.make( {
										A : {
											className :a.a.k
									...
									a.f.set(f, a.a.dataAttributePrefix + "log",
											"board_from_embedded_pin");
									f.appendChild(a.f.make( {
										IMG : {
											className :a.a.k
													+ "_embed_pin_text_avatar",
											src :b.board.image_thumbnail_url
										}
									}));
									f
											.appendChild(a.f
								...
								a.f
										.debug("Not enough data to embed a pin; aborting")
						}
					},
					user : function(b, d) {
						if ((d = a.d.getElementById(a.a.k + "_" + d)) && b.data
								&& b.data.pins && b.data.pins.length) {
							...
							e.appendChild(f);
							c.appendChild(e);
							if (b = a.f.tile(d, b.data.pins)) {
								c.appendChild(b);
								d.href += "pins/";
								c.appendChild(a.f.makeFooter(d, "embed_user"));
								a.f.cssHook(d, c);
								a.f.replace(d, c)
							}
						}
					...
					board : function(b, d) {
						if ((d = a.d.getElementById(a.a.k + "_" + d)) && b.data
							...
							if (a.f.getData(d, "style") !== "plain")
								c.className = c.className + " " + a.a.k
										+ "_fancy";
							var e = a.f.tile(d, b.data.pins), f = a.f.make( {
								SPAN : {
									className :a.a.k + "_embed_board_hd"
								}
							}), g = a.f.make( {
							...
							a.f.set(g, a.a.dataAttributePrefix + "log",
									"embed_board");
							f.appendChild(g);
							if (a.v.renderedWidth > a.a.tile.minWidthToShowAuxText) {
								b = a.f.make( {
								...
								a.f.set(b, a.a.dataAttributePrefix + "log",
										"embed_board");
								f.appendChild(b)
							} else
								g.className = a.a.k + "_embed_board_title";
							c.appendChild(f);
							if (e) {
								c.appendChild(e);
								c.appendChild(a.f.makeFooter(d, "embed_board"));
								a.f.cssHook(d, c);
								a.f.replace(d, c)
							}
						}
				...
				render : {
					buttonBookmark : function(b) {
						...
						var d = a.f.make( {
							A : {
								href :b.href,
								className :a.a.k + "_pin_it_button " + a.a.k
										+ "_pin_it_button_inline"
							}
						});
						a.f.set(d, a.a.dataAttributePrefix + "log",
								"button_pinit_bookmarklet");
						var c = a.f.getData(b, "config");
						if (a.a.config.pinItCountPosition[c] === true) {
							a.f.set(d, a.a.dataAttributePrefix + "config", c);
							d.className = d.className + " " + a.a.k
									+ "_pin_it_" + c
						} else
							d.className = d.className + " " + a.a.k
									+ "_pin_it_none";
					...
					buttonPin : function(b) {
						...
						if (a.a.config.pinItCountPosition[c] === true) {
							...
							d.className = d.className + " " + a.a.k
									+ "_pin_it_none";
						d.onclick = function() {
							var f = a.f.parse(this.href, {
								url :true,
								media :true
							});
							if (f.url && f.url.match(/^http/) && f.media
									&& f.media.match(/^http/))
								a.w.open(this.href, "pin"
										+ (new Date).getTime(), a.a.pop);
							else {
								a.f
										.log("&type=config_error&error_msg=invalid_url&href="
												+ encodeURIComponent(a.d.URL));
								a.f.fireBookmark()
							}
							if (a.v.logOnClick) {
								a.f.log(a.v.logOnClick);
								a.v.logOnClick = null
							}
							return false
						};
					...
					embedPin : function(b) {
						...
						(b = b.href.split("/")[4]) && parseInt(b, 10) > 0
								&& a.f.getPinsIn("pin", "", {
									pin_ids :b
								})
					},
					embedUser : function(b) {
						...
						(b = b.href.split("/")[3])
								&& a.f.getPinsIn("user", b + "/pins/")
					},
					embedBoard : function(b) {
						a.f.debug("build embedded board");
						var d = b.href.split("/")[3];
						b = b.href.split("/")[4];
						d
								&& b
								&& a.f.getPinsIn("board", d + "/" + b
										+ "/pins/")
					}
				},
				getPinsIn : function(b, d, c) {
					var e = "", f = "?", g;
					for (g in c)
						if (c[g].hasOwnProperty) {
							e = e + f + g + "=" + c[g];
							f = "&"
						}
					a.f.call(a.a.endpoint[b] + d + e, a.f.ping[b])
				},
				build : function(b) {
					if (typeof b !== "object" || b === null || !b.parentNode)
						b = a.d;
					var d = b.getElementsByTagName("A"), c, e, f, g = {
						vertical :"above",
						horizontal :"beside"
					}, h = [];
					c = 0;
					for (b = d.length; c < b; c += 1)
						h.push(d[c]);
					c = 0;
					for (b = h.length; c < b; c += 1)
						if (h[c].href && h[c].href.match(a.a.myDomain)) {
							d = a.f.getData(h[c], "do");
							if (!d && h[c].href.match(/pin\/create\/button/)) {
								d = "buttonPin";
								f = "none";
								if ((e = a.f.get(h[c], "count-layout")) && g[e])
									f = g[e];
								a.f.set(h[c], "data-pin-config", f);
								a.v.logOnClick = "&type=config_error&error_msg=legacy_config&href="
										+ encodeURIComponent(a.d.URL)
							}
							if (typeof a.f.render[d] === "function") {
								h[c].id = a.a.k + "_" + a.f.callback.length;
								a.f.render[d](h[c])
							}
						}
				},
				config : function() {
					...
					a.v.firstScript = b[0];
					for (c = 0; c < d; c += 1)
						if (a.a.me && b[c] && b[c].src
								&& b[c].src.match(a.a.me)) {
							if (e === false) {
								for (e = 0; e < a.a.configParam.length; e += 1)
									a.v.config[a.a.configParam[e]] = a.f.get(
											b[c], a.a.dataAttributePrefix
													+ a.a.configParam[e]);
								e = true
							}
							a.f.kill(b[c])
					...
					if (typeof a.v.config.build === "string")
						a.w[a.v.config.build] = function(f) {
							a.f.build(f)
						};
				...
				log : function(b) {
					var d = "?via=" + encodeURIComponent(a.v.here);
					if (d)
						d += b;
					a.f.call(a.a.endpoint.log + d, a.f.ping.log)
				},
				init : function() {
					...
					if (a.w.devicePixelRatio && a.w.devicePixelRatio >= 2)
						a.v.resolution = 2;
					a.f.config();
					a.f.build();
					a.f.presentation();
	...
	a.f.init()
		...
		(
				...
				document,
				{
					...
					configParam : [ "build", "do-not-log", "debug", "style",
							"hover" ],
